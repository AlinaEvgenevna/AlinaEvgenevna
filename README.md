...
| Настройка рассылки автоматических алертов в телеграм-чат | Написание алгорита поиска аномалий в данных, формирование алерта с текстом и графиками, отправка автоматизированных сообщений в телеграм. |    Python, Airflow, Telegram |
