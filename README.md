...
Я аналитик данных. Ниже можно найти список репозиториев и моих проектов с их описаниями (и иногда walkthrough guides). Все это я постепенно дорабатываю и дополняю.
...
| Tables   |      Are      |  Cool |
|----------|:-------------:|------:|
| Линейная регрессия |  left-aligned | $1600 |
